...
char flag=(char)65500;
    ...
    public StringBuilder coderV2(StringBuilder str) {
    ...
    public StringBuilder avtoCompress(StringBuilder str) {
...

        {
            if (amount == 1) {
                ...
                writer.append((char) amount);
                writer.append( str.charAt(str.length() - 1));
            }
    ...
    public  void preparationForCompression(Scanner scanner) {
    ...
    public  void compression(int[] data, boolean foto) {
        try {
    ...
    public StringBuilder autoDeCompression(StringBuilder str) {
